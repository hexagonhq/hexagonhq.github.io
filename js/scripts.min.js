...
$(function(){function e(){$(".carousel-services-item").each(function(){var e=($(this),$(this).find(".carousel-services-content").outerHeight());$(this).find(".carousel-services-image").css("min-height",e)})}function s(){$(".carousel-services-content").equalHeights()}$("#my-menu").mmenu({extensions:["theme-black","pagedim-black","fx-menu-slide","fx-listitems-slide"],navbar:{title:'<img src="img/logo/logo-1.svg" alt="Салон красоты Смитлер">'},offCanvas:{position:"right"}});var i=$("#my-menu").data("mmenu");i.bind("open:finish",function(){$(".hamburger").addClass("is-active")}),$("#hamburger").click(function(){i.open()}),i.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$("#hamburger").click(function(){i.close()}),$("#hamburger").appendTo("body"),$(".preloader").appendTo("body"),$(".carousel-services").on("initialized.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".carousel-services").owlCarousel({nav:!0,smartSpeed:700,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,dots:!1,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),e(),$(".carousel-services-composition .h3").each(function(){$(this);$(this).html($(this).html().replace(/(\S+)\s*$/,"<span>$1</span>"))}),$("section .h2").each(function(){$(this);$(this).html($(this).html().replace(/^(\S+)/,"<span>$1</span>"))}),$("select").selectize(),$(".carousel-reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1,autoHeight:!0}),$(".carousel-partners").owlCarousel({loop:!0,smartSpeed:700,nav:!0,dots:!1,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},768:{items:2},992:{items:3},1200:{items:4}}}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"show","swing")}),$("form.callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},1e3)}),!1}),s(),window.resize=function(){s()}}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("show")});